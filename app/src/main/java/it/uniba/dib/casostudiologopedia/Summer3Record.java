...
public class Summer3Record extends AppCompatActivity {
    ...
    public void onCreate(Bundle icicle) {
        ...
        setContentView(R.layout.summerecord3);
    ...
    public void avanti(View v){
        startActivity(new Intent(Summer3Record.this,MainActivity.class));
    }
}
