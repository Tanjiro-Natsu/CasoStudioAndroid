...
public class ListaBimbiCrea extends AppCompatActivity {
    FirebaseDatabase db;
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        FirebaseApp.initializeApp(ListaBimbiCrea.this);
        ...
        ref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for(int i=0;i<k;i++){
                    bt[i]=new MaterialButton(new ContextThemeWrapper(ListaBimbiCrea.this, com.google.android.material.R.style.Widget_MaterialComponents_Button_OutlinedButton), null, com.google.android.material.R.style.Widget_MaterialComponents_Button_OutlinedButton);
                    ...
                    bt[i].setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            Intent intent =new Intent(ListaBimbiCrea.this,BambinoCrea.class);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (item.getItemId() == android.R.id.home) {
            startActivity(new Intent(ListaBimbiCrea.this, mainLogopedista.class)) ;
        }
