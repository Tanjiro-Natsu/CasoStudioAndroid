...
public class Autunno2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FirebaseApp.initializeApp(Autunno2.this);
        setContentView(R.layout.gioco2autunno);
        FirebaseDatabase db= FirebaseDatabase.getInstance();
        DatabaseReference ref=db.getReference("App/Bambini").child(DatiBambino.getEmail()).child("Giochi").child("Ripetizione").child("Gioco3");
        ...
        button1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(Autunno2.this, Mappa.class));
            }
        });
            ...
            public void onClick(View v) {
                ...
                if (mStartRecording) {
                    ...
                    if(verifica==null){
                        ...
                        StorageReference imageRef = storageRef.child(DatiBambino.getEmail()+"/Registrazioni/Ripetizione/autunnorecord2.3gpp");
                        ...
                        ref1.addListenerForSingleValueEvent(new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull DataSnapshot snapshot) {
                                ...
                                ref1.child("Mappa").child("Tappa6").setValue(1);
                            }
    ...
    public String getpathfile(){
        ...
        fileName=new File(recording,"autunnorecord2"+".3gpp");
