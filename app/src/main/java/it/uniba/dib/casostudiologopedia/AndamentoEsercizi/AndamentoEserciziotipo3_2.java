...
public class AndamentoEserciziotipo3_2 extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        FirebaseApp.initializeApp(AndamentoEserciziotipo3_2.this);
        db=FirebaseDatabase.getInstance();
        ref=db.getReference("App/Bambini").child(DatiBambino.getEmail()).child("Giochi").child("Riconoscimento").child("Gioco2");
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (item.getItemId() == android.R.id.home) {
            startActivity(new Intent(AndamentoEserciziotipo3_2.this, CorrezionexBambino.class)) ;
        }
