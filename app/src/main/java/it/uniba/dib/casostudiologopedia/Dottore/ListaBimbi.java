...
public class ListaBimbi extends AppCompatActivity {
    FirebaseDatabase db;
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        FirebaseApp.initializeApp(ListaBimbi.this);
        ...
        ref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for(DataSnapshot ds :snapshot.getChildren()){
                    ...
                    eta.add(ds.child("eta").getValue(String.class));
                    lista.add(n1+" "+n2);
                    l++;
                }
                int k=lista.size();
                ...
                for(int i=0;i<k;i++){
                    bt[i]=new MaterialButton(new ContextThemeWrapper(ListaBimbi.this, com.google.android.material.R.style.Widget_MaterialComponents_Button_OutlinedButton), null, com.google.android.material.R.style.Widget_MaterialComponents_Button_OutlinedButton);
                    ...
                    bt[i].setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            Intent intent =new Intent(ListaBimbi.this,CalendarEvent.class);
                            DatiIntent.setNome(bt[t].getText().toString());
                            DatiIntent.setEmail(email.get(t));
                            DatiIntent.setEta(eta.get(t));
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (item.getItemId() == android.R.id.home) {
            startActivity(new Intent(ListaBimbi.this,mainLogopedista.class)) ;
        }
