...
public class Summer2Record extends AppCompatActivity {
    ...
    public void onCreate(Bundle icicle) {
        ...
        setContentView(R.layout.summerecord2);
    ...
    public void avanti(View v){
        startActivity(new Intent(Summer2Record.this,Summer3Record.class));
    }
}
