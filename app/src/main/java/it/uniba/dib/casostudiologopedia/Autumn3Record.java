...
public class Autumn3Record extends AppCompatActivity {
    ...
    public void onCreate(Bundle icicle) {
        ...
        setContentView(R.layout.autumnrecord3);
    ...
    public void avanti(View v){
        startActivity(new Intent(Autumn3Record.this,MainActivity.class));
    }
}
