...
texttospeech=new TextToSpeech(getApplicationContext(), new TextToSpeech.OnInitListener() {
    ...
    public void onInit(int status) {
        ...
        FirebaseApp.initializeApp(Winter1Record.this);
        FirebaseDatabase db= FirebaseDatabase.getInstance();
        DatabaseReference ref=db.getReference("App/Bambini").child(DatiBambino.getEmail()).child("Giochi").child("Denominazione").child("Gioco1");
        ref.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if(snapshot.child("aiuto_1").exists()){
                    aiuto1=snapshot.child("aiuto_1").getValue(String.class);
                }
                else{
                    aiuto1=" ";
                }
                if(snapshot.child("aiuto_2").exists()){
                    aiuto2=snapshot.child("aiuto_2").getValue(String.class);
                }
                else{
                    aiuto2=" ";
                }
                if(snapshot.child("aiuto_3").exists()){
                    aiuto3=snapshot.child("aiuto_3").getValue(String.class);
                }
                else{
                    aiuto3=" ";
                }
        ...
        dialog1=new Dialog(Winter1Record.this);
        ...
        button1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(Winter1Record.this, Mappa.class));
            }
        });
        ...
        recordButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (mStartRecording) {
                    ...
                    StorageReference imageRef = storageRef.child(DatiBambino.getEmail()+"/Registrazioni/Denominazione/invernorecord1.3gpp");
                    ...
                    ref1.addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                            ...
                            if(snapshot.child("Punteggio").exists()){
                                ...
                                ref1.child("Mappa").child("Tappa1").setValue(1);
                            }
                            else{
...
int speech=texttospeech.speak(aiuto1,texttospeech.QUEUE_FLUSH,null);
    ...
    public String getpathfile(){
        ...
        fileName=new File(recording,"invernorecord1"+".3gpp");
