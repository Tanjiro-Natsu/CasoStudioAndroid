...
public class Estate3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FirebaseApp.initializeApp(Estate3.this);
        setContentView(R.layout.estate3);
        FirebaseDatabase db= FirebaseDatabase.getInstance();
        DatabaseReference ref=db.getReference("App/Bambini").child(DatiBambino.getEmail()).child("Giochi").child("Riconoscimento").child("Gioco2");
        ref.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                audio=snapshot.child("audio").getValue(String.class);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(Estate3.this, Mappa.class));
            }
        });
                ...
                if(correzione==1){
                    ...
                    fer.addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                            ...
                            fer.child("Mappa").child("Tappa8").setValue(1);
                            fer.child("Giochi").child("Riconoscimento").child("Gioco2").child("Valutazione").setValue(1);
                        }
                    ...
                    fer.addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                            ...
                            fer.child("Mappa").child("Tappa8").setValue(1);
                            fer.child("Giochi").child("Riconoscimento").child("Gioco2").child("Valutazione").setValue(2);
                        }
