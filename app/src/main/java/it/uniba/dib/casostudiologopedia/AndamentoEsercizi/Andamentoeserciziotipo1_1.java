...
public class Andamentoeserciziotipo1_1 extends AppCompatActivity {
private ImageView image1;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        FirebaseApp.initializeApp(Andamentoeserciziotipo1_1.this);
        db=FirebaseDatabase.getInstance();
       ref=db.getReference("App/Bambini").child(DatiBambino.getEmail()).child("Giochi").child("Denominazione").child("Gioco1");
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (item.getItemId() == android.R.id.home) {
            startActivity(new Intent(Andamentoeserciziotipo1_1.this, CorrezionexBambino.class)) ;
        }
