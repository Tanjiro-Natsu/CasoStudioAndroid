...
public class Estate2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FirebaseApp.initializeApp(Estate2.this);
        setContentView(R.layout.gioco2estate);
        FirebaseDatabase db= FirebaseDatabase.getInstance();
        DatabaseReference ref=db.getReference("App/Bambini").child(DatiBambino.getEmail()).child("Giochi").child("Ripetizione").child("Gioco2");
        ...
        button1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(Estate2.this, Mappa.class));
            }
        });
        ...
        recordButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (mStartRecording) {
                    ...
                    StorageReference imageRef = storageRef.child(DatiBambino.getEmail()+"/Registrazioni/Ripetizione/estaterecord2.3gpp");
                    ...
                    ref1.addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                            ...
                            ref1.child("Mappa").child("Tappa5").setValue(1);
                        }
    ...
    public String getpathfile(){
        ...
        fileName=new File(recording,"estaterecord2"+".3gpp");
