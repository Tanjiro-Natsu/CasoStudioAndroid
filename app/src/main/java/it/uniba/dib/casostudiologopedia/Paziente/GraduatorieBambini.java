...
public class GraduatorieBambini extends AppCompatActivity {
    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        EditText text=new EditText(GraduatorieBambini.this);
        text.setText("          Nome               Punteggio");
        text.setTextColor(Color.WHITE);
        text.setTextSize(24);
        layer.addView(text);
        FirebaseApp.initializeApp(GraduatorieBambini.this);
        ...
        ref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for(int i=0;i<k;i++){
                    bt[i]=new MaterialButton(new ContextThemeWrapper(GraduatorieBambini.this, com.google.android.material.R.style.Widget_MaterialComponents_Button_OutlinedButton), null, com.google.android.material.R.style.Widget_MaterialComponents_Button_OutlinedButton);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (item.getItemId() == android.R.id.home) {
            startActivity(new Intent(GraduatorieBambini.this,mainBambino.class)) ;
        }
