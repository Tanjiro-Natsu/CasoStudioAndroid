...
public class Summer1Record extends AppCompatActivity {
    ...
    public void onCreate(Bundle icicle) {
        ...
        FirebaseApp.initializeApp(Summer1Record.this);
        FirebaseDatabase db= FirebaseDatabase.getInstance();
        DatabaseReference ref=db.getReference("App/Bambini").child(DatiBambino.getEmail()).child("Giochi").child("Denominazione").child("Gioco2");
        ...
        dialog1=new Dialog(Summer1Record.this);
        ...
        button1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(Summer1Record.this, Mappa.class));
            }
        });
        ...
        recordButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (mStartRecording) {
                    ...
                    StorageReference imageRef = storageRef.child(DatiBambino.getEmail()+"/Registrazioni/Denominazione/estaterecord1.3gpp");
                    ...
                    ref1.addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                            ...
                            ref1.child("Mappa").child("Tappa2").setValue(1);
                        }
    ...
    public String getpathfile(){
        ...
        fileName=new File(recording,"estaterecord1"+".3gpp");
