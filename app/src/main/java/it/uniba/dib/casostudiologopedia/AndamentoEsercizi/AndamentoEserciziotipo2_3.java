...
public class AndamentoEserciziotipo2_3 extends AppCompatActivity {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        FirebaseApp.initializeApp(AndamentoEserciziotipo2_3.this);
        db=FirebaseDatabase.getInstance();
        ref=db.getReference("App/Bambini").child(DatiBambino.getEmail()).child("Giochi").child("Ripetizione").child("Gioco3");
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (item.getItemId() == android.R.id.home) {
            startActivity(new Intent(AndamentoEserciziotipo2_3.this, CorrezionexBambino.class)) ;
        }
