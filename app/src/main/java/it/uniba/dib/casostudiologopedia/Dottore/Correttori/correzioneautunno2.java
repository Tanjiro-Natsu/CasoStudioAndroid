...
public class correzioneautunno2 extends AppCompatActivity {
    @Override
    public void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.correzioneautunno2);
        FirebaseApp.initializeApp(correzioneautunno2.this);
        ...
        bt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try{
                    ...
                    StorageReference islandRef = storageRef.child(DatiIntent.getEmail()).child("Registrazioni/Ripetizione/autunnorecord2.3gpp");
                    ContextWrapper cw=new ContextWrapper(getApplicationContext());
                    File recording=cw.getExternalFilesDir(Environment.DIRECTORY_RECORDINGS);
                    File LocalFile = new File(recording,"autunnorecord2"+".3gpp");
    ...
    public void corretto(View v){
        ...
        ref1.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                ref1.child("Giochi").child("Ripetizione").child("Gioco3").child("Correzione").setValue(1);
            }
    ...
    public void errato(View v){
        FirebaseDatabase db= FirebaseDatabase.getInstance();
        DatabaseReference ref1=db.getReference("App/Bambini").child(DatiIntent.getEmail());
        ref1.child("Giochi").child("Ripetizione").child("Gioco3").child("Correzione").setValue(2);
        Toast.makeText(this,"Correzione Avvenuta",Toast.LENGTH_SHORT).show();


    }
    public void back(View v){startActivity(new Intent(correzioneautunno2.this, BambinoCorrezione.class));}
}