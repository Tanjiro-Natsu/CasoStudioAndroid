...
public class Inverno3 extends AppCompatActivity {
   ...
   private TextToSpeech texttospeech;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FirebaseApp.initializeApp(Inverno3.this);
        setContentView(R.layout.inverno3);
        FirebaseDatabase db= FirebaseDatabase.getInstance();
        DatabaseReference ref=db.getReference("App/Bambini").child(DatiBambino.getEmail()).child("Giochi").child("Riconoscimento").child("Gioco1");
       ...
       dialog=new Dialog(Inverno3.this);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(Inverno3.this, Mappa.class));
            }
        });
                ...
                if(correzione==1){
                    ...
                    fer.addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                            ...
                            fer.child("Mappa").child("Tappa7").setValue(1);
                            fer.child("Giochi").child("Riconoscimento").child("Gioco1").child("Valutazione").setValue(1);
                        }
                    ...
                    fer.addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                            ...
                            fer.child("Mappa").child("Tappa7").setValue(1);
                            fer.child("Giochi").child("Riconoscimento").child("Gioco1").child("Valutazione").setValue(2);
                        }
