...
public class Winter2Record extends AppCompatActivity {
    ...
    public void onCreate(Bundle icicle) {
        ...
        setContentView(R.layout.winterecord2);
        recordButton =(Button)findViewById(R.id.record2winter);
    ...
    public void avanti(View v){
        startActivity(new Intent(Winter2Record.this,Winter3Record.class));
    }
}